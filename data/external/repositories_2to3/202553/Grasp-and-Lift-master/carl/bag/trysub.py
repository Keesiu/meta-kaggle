...
subjects = list(range(subx,subx+1))
...
def data_preprocess_train(X,subject):
    ...
    return get_fea(X_prep,cat='train',subject=subject)
    #return X_prep
...
def data_preprocess_test(X,subject):
    ...
    return get_fea(X_prep,cat='test',subject=subject)
    #return X_prep
...
# submission file
submission_file = 'sub/try_sub%d_clf%d_trode%d.csv'%(subx,cl,electrode)
