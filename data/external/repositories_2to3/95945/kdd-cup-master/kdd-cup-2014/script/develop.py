...
if __name__=="__main__":
    ...
    # development
    parameters_n_estimators = list(range(5, 1000 + 1, 10))
    ...
    #for parameter_1, parameter_2, parameter_3 in parameters:   
        ...
        # log: print time
        print("new classifier with parameter(%d, %d, %d) at time %s ... " % (parameter_1, parameter_2, parameter_3, time.ctime()), end=' ')
        ...
        # log: print time
        print("training classifier at time %s ... " % time.ctime(), end=' ')
        ...
        # log: print time
        print("predicting training set at time %s ... " % time.ctime(), end=' ')
        ...
        # log: print time
        print("predicting validation set at time %s ... " % time.ctime(), end=' ')
