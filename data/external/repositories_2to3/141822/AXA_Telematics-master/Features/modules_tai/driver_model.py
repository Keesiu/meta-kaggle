...
CURV_TRONCON = list(range(7)) #How much portions do we keep
CURV_TRONCON_BIGTURN = list(range(4)) #How much portions do we keep
SPEED_DELTA_PORTION = 20 # discretization of speed into trunc of 20
SPEED_TRONCON = list(range(8)) #How much speed portions do we keep
TIMEDELTA_AHEAD = 4
TIMEDELTA_BEFORE = 4
...
class DriverModel(object):
        ...
        def aggregateCatData(self):
                ...
                for idx, trip in enumerate(self.nptrips):
                        ...
                        for key in list(agg_data_speed.keys()):
                        ...
                        for key in list(agg_data_curv.keys()):
                        ...
                        for key in list(agg_data_curv_before.keys()):
                        ...
                        for key in list(agg_data_curv_ahead.keys()):
