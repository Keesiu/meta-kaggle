...
if __name__ == '__main__':
    ...
    superclass = [str.split('_')[0] for str in y_enc.classes_]
    y_train_superclass = [superclass[x] for x in y_train]
    y_train_train_superclass = [superclass[x] for x in y_train_train]
    y_train_test_superclass = [superclass[x] for x in y_train_test]
