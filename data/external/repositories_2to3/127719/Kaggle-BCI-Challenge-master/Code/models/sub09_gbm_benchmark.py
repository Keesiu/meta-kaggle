...
train = pd.DataFrame(columns=['Cz_' + s for s in map(str,list(range(261)))],index=list(range(5440)))
counter = 0
...
test = pd.DataFrame(columns=['Cz_' + s for s in map(str,list(range(261)))],index=list(range(3400)))
