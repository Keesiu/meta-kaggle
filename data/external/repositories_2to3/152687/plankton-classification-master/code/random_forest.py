...
labels = [s.split('/')[-1] for s in namesClasses]
...
images = [fileName.split('/')[-1] for fileName in fnames]
i = 0
# report progress for each 5% done  
