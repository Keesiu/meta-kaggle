...
class GalData(Dataset):
    ...
    def load(self, **kwargs):
        ...
        if validate:
            ...
            train, trainlabs, _ = self.readfiles('train', list(range(1, 7)))
            test, testlabs, self.testinds = self.readfiles('train', [7, 8])
...
if __name__ == '__main__':
    ...
    if validate:
        ...
        subm.to_csv('subm_cv.csv', index_label='id', float_format='%.4f')
    print('Done.')
