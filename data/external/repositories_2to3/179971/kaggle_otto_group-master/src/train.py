...
def main(path="../data/",k=5,log='add',pca_n=0,rfe=45,SEED=34):
	...
	for l in nnetRawModel:
		train[list(l.keys())[0]+'_nnet_raw_pred'] = l[list(l.keys())[0]]['pred']
		test[list(l.keys())[0]+'_nnet_raw_pred'] = l[list(l.keys())[0]]['test_pred']
	...
	for l in rfModel:
		train[list(l.keys())[0]+'_rf_pred'] = l[list(l.keys())[0]]['pred']
		test[list(l.keys())[0]+'_rf_pred'] = l[list(l.keys())[0]]['test_pred']
	...
	for l in gbmModel:
		train[list(l.keys())[0]+'_gbm_pred'] = l[list(l.keys())[0]]['pred']
		test[list(l.keys())[0]+'_gbm_pred'] = l[list(l.keys())[0]]['test_pred']
	...
	for l in glmModel:
		train[list(l.keys())[0]+'_glm_pred'] = l[list(l.keys())[0]]['pred']
		test[list(l.keys())[0]+'_glm_pred'] = l[list(l.keys())[0]]['test_pred']
	...
	for l in svmModel:
		train[list(l.keys())[0]+'_svm_pred'] = l[list(l.keys())[0]]['pred']
		test[list(l.keys())[0]+'_svm_pred'] = l[list(l.keys())[0]]['test_pred']
	...
	for label in target.unique():
		...
		train[label+'_ensemble_pred'] = applyWeights(train[[x for x in list(weights.keys())]],weights)
		test[label+'_ensemble_pred'] = applyWeights(test[[x for x in list(weights.keys())]],weights)
