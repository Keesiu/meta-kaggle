...
class RotateBatchIteratorMixin(object):
    ...
    """
    def __init__(self, rotate_n=2, angle_choices=list(range(0, 360, 10)), *args, **kwargs):
...
class TranslateBatchIteratorMixin(object):
    ...
    """
    def __init__(self, translate_n=2, translate_choices=list(range(-5, 6)), *args, **kwargs):
...
class AffineTransformIteratorMixin(object):
    ...
    def __init__(self, affine_n=2,
                 ...
                 translate_choices=list(range(-5, 6)),
                 angle_choices=list(range(0, 360, 10)), *args, **kwargs):
