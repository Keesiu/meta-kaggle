...
def main():
    ...
    # logloss
    plt.plot(list(range(len(logloss_single))), logloss_single)
    plt.plot(list(range(len(logloss_ensemble))), logloss_ensemble)
    plt.plot(list(range(len(logloss_ensemble))), logloss_ensemble_min * np.ones((len(logloss_ensemble))))
