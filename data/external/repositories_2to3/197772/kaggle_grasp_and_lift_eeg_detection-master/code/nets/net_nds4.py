...
def create_net(train_source, test_source, filter1_width=7, n_features=4, dense=1024, maxout=2, 
               ch=None, sample_size=4096, batch_size=32, max_epochs=100, rate=0.04, patience=20): 
    ...
    layers = [
        ...
        LF(ReshapeLayer, shape=([0], SAMPLE_SIZE//8, 8*batch_iter_train.n_channels)),
        LF(DimshuffleLayer, pattern=(0,2,1)),        
        LF(NINLayer, num_units=n_features, nonlinearity=None),  
        #
        LF(Conv1DLayer, num_filters=16, filter_size=filter1_width, 
...
# Overall score 0.978 after running for 30 epochs
# ('Overall score:', 0.97890497179621716) when validation=1
