...
def cost_per_choice(golden, golden_loc, predictions):
    ...
    for i, (g, loc, p) in enumerate(zip(golden, golden_loc, predictions)):
...
if __name__ == "__main__":
    ...
    for i, (p, g, gi, parse, rparse) in enumerate(zip(predictions, golden, golden_loc, args.parses, args.removed_parses)):
