...
for dia_sys in ["dia" + ext, "sys" + ext]:
    ...
    print("\t".join([str(x).rjust(10) for x in ["Fold", "Train-n", "Validate-n", "Raw", "Raw^2", "Raw mi", "Raw mx", "Train", "Train^2", "Train mi", "Train mx", "Validate", "Validate^2", "Validate mi", "Validate mx", "MAE"]]))
    for fold_range in fold_ranges:
        ...
        # print
        print("\t".join([str(x).rjust(10) for x in print_values]))
