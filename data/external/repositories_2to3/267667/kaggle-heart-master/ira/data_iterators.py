...
class PatientsDataGenerator(object):
    def __init__(self, data_path, batch_size, transform_params, patient_ids=None, labels_path=None,
        ...
        self.patient_ids = list(self.pid2slice_paths.keys())
        ...
        while True:
            ...
            for pos in range(0, len(rand_idxs), self.batch_size):
                ...
                for i, idx in enumerate(idxs_batch):
                    ...
                    slice_paths = sorted(list(slicepath2location.keys()), key=slicepath2location.get)
...
class Ch2Ch4DataGenerator(object):
    def __init__(self, data_path, batch_size, transform_params, patient_ids=None, labels_path=None,
        ...
        self.patient_ids = list(self.pid2sax_slice_paths.keys())
        self.nsamples = len(self.patient_ids)
